...
/*
 *  This visitor will output HIR in lowered form. This is pretty much for testing purposes.
 *
 ...
 */
public sealed class IRLowererHIR : IRVisitorGeneric {
    private int tempCounter;

    public IRLowererHIR(int tempCounter) {
