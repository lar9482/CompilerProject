 ...
 *
 * How this will work.
 * 1. The expression is declared as a string.
 * 2. The expected strings tokens for the expression will be defined. 
 * 3. The expression is parsed, then traversed using 'ExprVisitor.cs' in-order.
 * 4. The string tokens generated by the ExprVisitor and the expected tokens are compared.
 */
